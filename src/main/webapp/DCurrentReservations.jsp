...
<html>
	...
	<body>
		...
		Econ Current Reservations <!-- the usual HTML way -->
		<br>
	...
	<table>
		...
		This is a warning that if you click Remove, you will have to pay a cancel charge.
		<form action="DCurrentReservations" method = "POST">
